...
def datasynthesiser():
    ...
    try:
        loaded_model = tf.keras.models.load_model('models/DNN/model/power_flow_nn_model.h5')
        loaded_input_scaler = joblib.load('models/DNN/model/input_scaler.pkl')
        loaded_output_scaler = joblib.load('models/DNN/model/output_scaler.pkl')
