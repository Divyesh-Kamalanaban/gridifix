...
# import src.initcigre as initcigre
# import src.dlpfcoeff as dlpfcoeff
# import src.solvedlpf as solvedlpf
# import src.erroranalysisdlpf as erroranalysisdlpf
# import src.dermodelling as dermodelling
# import src.samplegenerator as samplegenerator  # Import your module containing generate_samples
import pandas as pd
...
try:
    loaded_nn_model = tf.keras.models.load_model('models/DNN/model/power_flow_nn_model.h5')
    loaded_input_scaler = joblib.load('models/DNN/model/scalers/input_scaler.pkl')
    loaded_output_scaler = joblib.load('models/DNN/model/scalers/output_scaler.pkl')
    fault_detection_model = ydf.load_model('models/fault_detection_model/content/fault_detection_model')
    fault_locate_model = ydf.load_model('models/fault_locate_model/content/fault_locate_model')
...
temp_inputs_df_for_cols = pd.read_csv("datasets/combined_power_flow_inputs.csv")
temp_outputs_df_for_cols = pd.read_csv("datasets/combined_power_flow_outputs.csv")
